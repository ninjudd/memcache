...
several important ways. First, I have renamed the main class from MemCache to Memcache to
prevent confusion and to force those switching to _memcache_ to update their code.

=== Interface

I tried to keep the basic interface as similar as I could to memcache-client. In some
cases, _memcache_ can be a drop-in replacement for memcache-client. There are some important
differences though.
...
- Support for flags has been added to all 
