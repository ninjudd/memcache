...
cases, _memcache_ can be a near drop-in replacement for memcache-client. There are differences though.

- I renamed the main class from +MemCache+ to +Memcache+ to prevent confusion and to force
  those switching to _memcache_ to update their code.
